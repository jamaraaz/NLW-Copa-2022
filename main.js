function createGame(player1, hour, player2) {
  return `
    <li>
        <img src="./assets/icon-${player1}.svg" alt="Bandeira ${player1} title="Bandeira ${player1}"/>
        <strong>${hour}</strong>
        <img src="./assets/icon-${player2}.svg" alt="Bandeira ${player2} title="Bandeira ${player2}" />
    </li>
    `;
}
...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    "03/12",
    "sábado",
    createGame("tbd", "12:00", "tbd") + createGame("tbd", "16:00", "tbd")
  ) +
  createCard(
    "oitavas de final",
    "04/12",
  ...
  createCard("semifinal", "13/12", "terça", createGame("tbd", "16:00", "tbd")) +
  createCard(
    "semifinal",
    "14/12",
    "quarta",
  ...
  createCard("final", "18/12", "domingo", createGame("tbd", "12:00", "tbd"));
